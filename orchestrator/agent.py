...
# Роли, которым каркас пишущей роли не едет. Общее у них одно: они не
# сочиняют слов. Дизайнеру запрещено ставить на макет слово, которого нет
# в тексте Редактора; Монтажёр двигает границы куска, а всё, что попадёт
# в ролик, уже произнесено на записи. Голос, анти-AI, признаки машинного
# текста и правила достоверности им применять не к чему — 3674 знака в
# каждом вызове, из которых ни одно правило не про их работу.
#
