...
def _state(chat_id: int) -> str:
    ...
    lines = [
        ...
        "Подключены роли: Ассистент, Ресёрчер (распаковка бренда), "
        "Стратег (план недели), Редактор (тексты постов).",
        "Ещё не подключены: внешний ресёрч и метрики, сценарии Reels, "
        "визуал, публикация — это следующие шаги сборки.",
