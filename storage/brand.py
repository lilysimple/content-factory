...
#
# Файла нет в этом списке — его не читает никто, и лежит он в папке
# бренда мёртвым грузом. На `rubrics.md` это стоило трёх недель: файл
# завели 05.09, Стратег всё это время писал в каждый план «рубрикатора
# бренда нет» и сочинял разовые рубрики, а таблица лежала рядом.
PROFILE = {
    "core":      "core.md",
    "goals":     "goals.md",
